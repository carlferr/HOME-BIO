		...
		if split_pairend == "no":
			...
			for i in range(0,len(fastq),1):
				...
				if split_delete == "yes" :
					...
					os.system("bowtie2 -p "+n_thread+" --end-to-end --very-sensitive --met-file "+split_output_path+"/3_Bowtie2_Alignment/"+sample_only_name_a_noR1[0]+"_metrics_file_host.txt --un "+split_output_path+"/3_Bowtie2_Alignment/"+sample_only_name_a_noR1[0]+"_reads_not_align_host.fastq --al "+split_output_path+"/3_Bowtie2_Alignment/"+sample_only_name_a_noR1[0]+"_reads_align_host.fastq -x "+path_delete+" -U "+split_output_path+"/2_Fastq_trimmed/"+sample_only_name_a[0]+"_trimmed.fastq -S "+split_output_path+"/3_Bowtie2_Alignment/"+sample_only_name_a_noR1[0]+"host.sam")
